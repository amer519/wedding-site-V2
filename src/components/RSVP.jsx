...
const RSVP = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const formURL = "https://docs.google.com/forms/u/0/d/e/1FAIpQLSc7RVbWopToXSISCLVVt3zZXhBsVa8favkIExu055Skwl9Q7A/formResponse"; // Your formResponse URL
  ...
  return (
    <section id="rsvp" className="rsvp-section">
      ...
      <form onSubmit={handleSubmit} className="rsvp-form">
        ...
        <select name="mealPreference" value={formData.mealPreference} onChange={handleChange} required>
